...
enum MP_GRID_CELL_COLOR_THEME
{
	...
	MP_GRID_COLOR_LIGHT_BLUE,
	MP_GRID_COLOR_LIGHT_ORANGE,
	MP_GRID_COLOR_LIGHT_GRAY,
	MP_GRID_COLOR_LIGHT_YELLOW,
	MP_GRID_COLOR_GREEN,
	MP_GRID_COLOR_LIGHT_GREEN,
	MP_GRID_COLOR_DARK_GREEN,
	MP_GRID_COLOR_ORANGE,
	MP_GRID_COLOR_DARK_ORANGE,
	MP_GRID_COLOR_BK_WIHTE,
	MP_GRID_COLOR_PURPLE,
	MP_GRID_COLOR_BLACK
};
...
inline COLORREF MpGridThemeBkColor(MP_GRID_CELL_COLOR_THEME theme)
{
	...
	case MP_GRID_COLOR_LIGHT_BLUE: return RGB(189, 215, 238);
	case MP_GRID_COLOR_LIGHT_ORANGE: return RGB(248, 203, 173);
	case MP_GRID_COLOR_LIGHT_GRAY: return RGB(217, 217, 217);
	case MP_GRID_COLOR_LIGHT_YELLOW: return RGB(255, 242, 204);
	case MP_GRID_COLOR_GREEN: return RGB(112, 173, 71);
	case MP_GRID_COLOR_LIGHT_GREEN: return RGB(241, 247, 237);
	case MP_GRID_COLOR_DARK_GREEN: return RGB(128, 176, 128);
	...
	case MP_GRID_COLOR_PURPLE: return RGB(222,102, 255);
...
inline COLORREF MpGridThemeTextColor(MP_GRID_CELL_COLOR_THEME theme)
{
	...
	case MP_GRID_COLOR_LIGHT_YELLOW:
	case MP_GRID_COLOR_GREEN:
	case MP_GRID_COLOR_LIGHT_GREEN:
	default:
		return RGB(0, 0, 0);
	}
}
...
inline LPCTSTR MpGridThemeText(MP_GRID_CELL_COLOR_THEME theme)
{
	...
	case MP_GRID_COLOR_LIGHT_BLUE: return _T("MP_GRID_COLOR_LIGHT_BLUE");
	case MP_GRID_COLOR_LIGHT_ORANGE: return _T("MP_GRID_COLOR_LIGHT_ORANGE");
	case MP_GRID_COLOR_LIGHT_GRAY: return _T("MP_GRID_COLOR_LIGHT_GRAY");
	case MP_GRID_COLOR_LIGHT_YELLOW: return _T("MP_GRID_COLOR_LIGHT_YELLOW");
	case MP_GRID_COLOR_GREEN: return _T("MP_GRID_COLOR_GREEN");
	case MP_GRID_COLOR_LIGHT_GREEN: return _T("MP_GRID_COLOR_LIGHT_GREEN");
